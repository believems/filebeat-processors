...
func (p TPrimitiveType) String() string {
	...
	case TPrimitiveType_VARCHAR:
		return "VARCHAR"
	case TPrimitiveType_FIXED_UDA_INTERMEDIATE:
...
func TPrimitiveTypeFromString(s string) (TPrimitiveType, error) {
	...
	case "FIXED_UDA_INTERMEDIATE":
		return TPrimitiveType_FIXED_UDA_INTERMEDIATE, nil
	}
...
func (p TStmtType) String() string {
	...
	case TStmtType_SET:
		return "SET"
	case TStmtType_ADMIN_FN:
		return "ADMIN_FN"
	case TStmtType_TESTCASE:
		return "TESTCASE"
	}
	return "<UNSET>"
}
...
func TStmtTypeFromString(s string) (TStmtType, error) {
	...
	case "ADMIN_FN":
		return TStmtType_ADMIN_FN, nil
	case "TESTCASE":
		return TStmtType_TESTCASE, nil
	}
...
func TFunctionBinaryTypeFromString(s string) (TFunctionBinaryType, error) {
	...
	case "JAVA":
		return TFunctionBinaryType_JAVA, nil
	case "NATIVE":
...
func (p TSortingOrder) String() string {
	switch p {
	case TSortingOrder_LEXICAL:
		return "LEXICAL"
	case TSortingOrder_ZORDER:
		return "ZORDER"
	}
	return "<UNSET>"
}
...
func TSortingOrderFromString(s string) (TSortingOrder, error) {
	switch s {
	case "LEXICAL":
		return TSortingOrder_LEXICAL, nil
	case "ZORDER":
		return TSortingOrder_ZORDER, nil
	}
...
func (p *TStructField) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetFieldID() {
		if err := oprot.WriteFieldBegin("field_id", thrift.I32, 3); err != nil {
...
func (p *TNetworkAddress) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return thrift.PrependError("error reading field 3: ", err)
	} else {
		p.UdsAddress = &v
...
func (p *TNetworkAddress) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetUdsAddress() {
		if err := oprot.WriteFieldBegin("uds_address", thrift.STRING, 3); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:uds_address: ", p), err)
		}
		if err := oprot.WriteString(string(*p.UdsAddress)); err != nil {
...
func (p *TFunction) writeField12(oprot thrift.TProtocol) (err error) {
	if p.IsSetLastModifiedTime() {
		if err := oprot.WriteFieldBegin("last_modified_time", thrift.I64, 12); err != nil {
